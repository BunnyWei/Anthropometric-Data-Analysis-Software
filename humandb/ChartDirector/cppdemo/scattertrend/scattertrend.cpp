...
int main(int argc, char *argv[])
{
    ...
    c->addScatterLayer(DoubleArray(dataX0, sizeof(dataX0)/sizeof(dataX0[0])),
        DoubleArray(dataY0, sizeof(dataY0)/sizeof(dataY0[0])), "Server AAA",
        Chart::DiamondSymbol, 11, 0x008000);

    // Add a trend line layer for (dataX0, dataY0)
    c->addTrendLayer(DoubleArray(dataX0, sizeof(dataX0)/sizeof(dataX0[0])),
        DoubleArray(dataY0, sizeof(dataY0)/sizeof(dataY0[0])), 0x008000
        )->setLineWidth(3);
