...
#include <../humandb/interfaces.h>
#include <../humandb/statistic.h>
...
class EditPickPointsPlugin : public QObject, public MeshEditInterface
{
	...
	static EditPickPointsPlugin *self;
...
public:
	...
	static EditPickPointsPlugin *instance()
	{
		return self;
	}
	...
	void paintPickedPoints(std::vector<MyPoint *> &pointVector);
private:
