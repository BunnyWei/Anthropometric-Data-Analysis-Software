...
EditPickPointsPlugin *EditPickPointsPlugin::self = 0;
...
void EditPickPointsPlugin::paintPickedPoints(std::vector<MyPoint *> &pointVector)
{
	assert(glArea);
