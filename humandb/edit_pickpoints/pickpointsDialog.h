...
private:
	...
	void addPoint(vcg::Point3f &point, QString &name,  bool present, QString itemName);
	
	//handle everything involved with adding a point to the tree widget
	PickedPointTreeWidgetItem * addTreeWidgetItemForPoint(vcg::Point3f &point, QString &name, CMeshO::FaceType::NormalType &faceNormal, bool present, QString itemName);
