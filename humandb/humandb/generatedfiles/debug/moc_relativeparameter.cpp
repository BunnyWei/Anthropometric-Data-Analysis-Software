...
static const char qt_meta_stringdata_RelativeParameter[] = {
    "RelativeParameter\0\0"
    "on_typeComboBox_textChanged(QString)\0"
...
int RelativeParameter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_typeComboBox_textChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: on_listWidget_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 2: on_staBtn_clicked(); break;
        case 3: on_tableComboBox_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: on_typeComboBox_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
